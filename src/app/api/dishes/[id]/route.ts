  ...
  try {
    const dish = await prisma.dish.update({
      ...
      data: {
        ...
        description,
        quickPrep,
        prepTime: prepTime === undefined || prepTime === null || prepTime === '' ? undefined : { set: Number(prepTime) },
        cookTime: cookTime === undefined || cookTime === null || cookTime === '' ? undefined : { set: Number(cookTime) },
        imageUrl,
